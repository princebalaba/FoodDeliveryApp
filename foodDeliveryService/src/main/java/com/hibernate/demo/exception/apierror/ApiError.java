package com.hibernate.demo.exception.apierror;
...
public class ApiError {
	...
	private ApiError() {
		localDateTime = LocalDateTime.now(); // @ the time of calling this constructor whatever the date time value is there , it will 
		// use it.
